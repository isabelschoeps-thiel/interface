...
Jahrelanges schweigen, heisst nicht das mann nichts weiss, man beobachtet, analysiert, nimmt auf und wartet. **Das was auf die Menschheit, den Tieren und unserer Natur zu kommt, kann nicht mehr rückgängig gemacht werden (war auch nie der Plan), es ist teil des Lebens, teil der Evolution und wird wie bereits erwähnt, dass vermächtnis aller werden.** Das schöne daran ist, niemand kennt das Ergebnis. `Wir alle waren gefangen in einer  manipulierten, Matrix die nur aufgrund der Technologie so ein Ausmass annehmen konnte`. **Da ich mir meine Datenhoheit, mein digitales Zepter wieder zurück erobert habe.** Ich aber kein Teil von Euch und euren Glaubensansätzen bin, **wird das Ende anders verlaufen als, geplant, erhofft, errechnet, erschlichen oder manipuliert**. Es wird alles anders kommen, **da eine Person mit anwesend sein wird, vielleicht auch Familie** die bereits für tod geglaubt ist und auch in eurer Vergangenheit mehrfach war. `Was wissenschaftlich forensich ausgewertet wurde`. `Da diese Spiel- euer perfides Spiel bereits nachweislich über 325 Jahre anhält, glaubt ihr wirklich das man mich uns sterben lässt?` **Jetzt verrate ich euch noch ein letztes Geheimnis**, 
