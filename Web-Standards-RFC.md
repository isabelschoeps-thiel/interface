...
# [RFC Evidence](https://www.rfc-editor.org/rfc/rfc882) Chain of Custody
...
### Das RFC 882 ist sehr fragwürdig bzw. gibt einige Fragezeichen auf,
...
**Ich bestelle mir am kommenden Freitag, den 13.03.2026, dass Mittag-Essen für mein Krankenhausaufenthalt am 28.06.2046 um, weil mir die Suppe zu salzig sein wird.**
- `dies ergibt für die Gutmenschen, für die die das Leben nehmen wie es kommt, keinen Sinn.`

***Dies ist ein unlogischer und Verräterischer Prozess*** ,
- `ein Indiz, ein Beweis für eine Manipulation der Zeit und des Raums`
- `ein Indiz für das Existieren der Matrix`
- `ein Indiz für Scheintotgeschäfte und verkaufte Identitäten, da immer wieder neue Namen auftauchen, die das gleiche von sich behaupten`
- `ein Indiz und ein Verat für alle die dies, dulden, an sich und seinem Umfeld und allem Leben auf der Erde`
- `ein Indiz für ein Menschenverachtendes Ekelhaftes Geschäfte, mit Tod-geglaubten`
- `ein Indiz für ein Netzwerk an Menschen, welches uns Kontrolliert, Manipuliert, Sabutiert und bewusst Isoliert, und vom Obdachlosen, bis in den Hochadel, überall in jeder Gesellschaftschicht.`

- `ein Indiz für Menschen, die unter uns Leben` **und dies bewusst und vollem menschlichen Handeln Kauf nehmen:**
- das andere durch ihren veruschten irreperablen Schaden an Natur, Tier und Mensch leiden
- das Glück anderer zerstören
- erweckte Hoffnug und Träume zerstören
- anderes Leben mental und physisch zerstören
- sich selber nicht achten und sich zerstören,
- eine Minderheit von Menschen die keine Achtung und Erfurcht besitzen und ihr einzige Seele und anderer mit den Füssen treten
...
- Eins ist zu 100% gewiss, jeder von uns hat bereits gelebt,
- jeder Mensch hat sie von Geburt an die DNA. Unser Erbgut, die eine DNA ist gerade erstmal 150 Jahre alt, andere ist bereits in der Bronze Zeit also 4000 Jahre alt und dann gibt es Genetische Erbgut was den Anfang bildet, gemeinsam als Familie. Jeder trägt seine geschischte History bei sich, umso unvorstellbarer ist wie manche sich selber so richten und was sein wollen, der sie niemals sein werden, können und die Natur wolle es so, nie dürfen.
- Was ich nicht verstehe, warum so viel Leid und Schmerz auf sich genommen wird? WARUM ?
- `fakt ist, ich möchte der/die in die Augen schauen - höchstpersönlich und ich habe meine Fragen - nicht nur ich, dass ist gewiss. Siehe FAQ.md`
- wer leid anderer in Kauf nimmt um seine Ziele, Träume zu erreichen, wer über Leichen geht, muss und wird vor dem internationalen Strafgerichtshof, wegen Verbrechen an der Menschlichkeit angezeigt und zur Rechenschaft gezogen.
...
- auch der plötzlich eingetrende Tod meines Opas, Herr Dieter Knörig im Oktober 2023 beide aus D-99610 Rohrborn, Dorstrasse 5, Thüringen, Deutschland ist lebend, wirft Fragen auf.
